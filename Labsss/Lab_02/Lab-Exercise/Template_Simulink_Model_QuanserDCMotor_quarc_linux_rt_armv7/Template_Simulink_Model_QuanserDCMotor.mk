...
#
# File    : quarc_linux_rt_armv7.tmf   $Revision: 1.0.0.0 $
#
# Abstract:
...
#       file that contains 'rtwgensettings.BuildDirSuffix' see quarc_linux_rt_armv7.tlc
...
HOST             = PC
BUILD            = yes
SYS_TARGET_FILE  = quarc_linux_rt_armv7.tlc
...
MODEL                = Template_Simulink_Model_QuanserDCMotor
MODULES              = Template_Simulink_Model_QuanserDCMotor_data.c Template_Simulink_Model_QuanserDCMotor_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = Template_Simulink_Model_QuanserDCMotor.mk
...
S_FUNCTIONS_LIB      = C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/libhil.a C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/LIBQUA~4.A
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 3
COMPUTER             = PCWIN64
BUILDARGS            =  MAT_FILE=0 DEBUG=0 DEBUG_HEAP=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = Template_Simulink_Model_QuanserDCMotorlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
include $(QUARC)/include/linux_rt_armv7_tools.mk
...
MATLAB_INCLUDES:=$(MATLAB_INCLUDES);C:/Users/MYPROJ~1/Desktop/Labsss/LAB-EX~1
MATLAB_INCLUDES:=$(MATLAB_INCLUDES);C:/Users/MYPROJ~1/Desktop/Labsss/LAB-EX~1/Template_Simulink_Model_QuanserDCMotor_quarc_linux_rt_armv7
MATLAB_INCLUDES:=$(MATLAB_INCLUDES);$(MATLAB_ROOT)/extern/include
...
CPP_REQ_DEFINES = -DMODEL=$(MODEL) -DRT -DNUMST=$(NUMST) \
                  ...
                  -DVXWORKS -DQUARC -D_GNU_SOURCE -DTARGET_TYPE=linux_rt_armv7 -D__LINUX_RT_ARMV7__ \
...
LDFLAGS := $(SYSROOT) $(LDFLAGS) -Wl,--hash-style=gnu -Wl,--as-needed -L$(QUARC)/lib/linux_rt_armv7
